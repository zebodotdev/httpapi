...
type AuditSink interface {
	// RecordRequest persists or forwards a completed request audit. The context
	// is the original request context captured before endpoint timeout wrapping.
...
// RecordRequest ignores the completed request audit.
